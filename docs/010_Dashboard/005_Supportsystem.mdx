...
Bitte beachten Sie, dass die Chats benutzerabhängig sind! Wenn Sie uns von einem Nutzeraccount schreiben, können dies
 nicht alle anderen Nutzer lesen!

:::

## Alte Nachrichten lesen

Mit einem Klick auf "Nachrichten" erreichen Sie die bisherigen Nachrichten, ohne, dass Sie dafür Ihre Emails lesen müssen!

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/erweiterungen/nachrichtenverlauf3.png').default}/>
</p>

## Neue Nachrichten erkennen

Auch neue Nachrichten, die wir Ihnen senden, werden Ihnen angezeigt, diese erkennen Sie an einem roten Badge:

![](../../static/img/erweiterungen/badge_news1.png)

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/erweiterungen/badge_news2.png').default}/>
</p>
