...
<iframe width="560" height="315" src="https://www.youtube.com/embed/lMsGuKd96Pk" title="YouTube video player" frameborder="0"
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_tierneu2.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_termine.png').default}/>
</p>

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_ta_wahl_praxis.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_tagrau.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_tagewahl.png').default}/>
</p>

Anschließend muss die Tageszeit gewählt werden, anschließend werden die Zeiten angeboten.

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_vormittag.png').default}/>
</p>


<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_zeitwahl.png').default}/>
</p>

Nach Auswahl und Klick **Weiter** gelangt man zur Tierauswahl.

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_tierwahl3.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_tiermapping.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_kommentar.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_terminbest.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_terminabsagen.png').default}/>
</p>

Anschließend wird der Termin in der Terminübersicht als "abgesagt" gekennzeichnet.

<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_terminabgesagt.png').default}/>
</p>
...
<p className={'vertical-image-wrapper'}>
    <img src={require('../../static/img/Kunden/app_erstehilfe.png').default}/>
</p>
